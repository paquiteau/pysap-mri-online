...
def gradient_online(opt_cls, kspace_generator, gradient_op, linear_op, prox_op, cost_op,
    ...
    opt = opt_cls(x=x_init,
                  ...
                  metrics=metrics,
                  **kwargs)
    return online_algorithm(opt, kspace_generator, verbose=verbose, estimate_call_period=estimate_call_period, nb_run=nb_run)


def gradient_online_analysis(opt_cls, kspace_generator, gradient_op, linear_op, prox_op, cost_op,
                    x_init=None,
                    nb_run=1,
                    metric_call_period=5,
                    metrics=None,
